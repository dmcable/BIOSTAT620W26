...
abstracts <- readLines('TEXTFILE', warn = FALSE)
# combine all text into one character
abstracts <- paste(YOURCODEHERE) 
# split the text whenever 3 new lines occur in a row (indicating two blank lines)
abstracts <- strsplit(YOURCODEHERE)
# replace any remaining "\n" symbols with spaces
abstracts <- gsub("REGEX", " ", abstracts)
...
abstracts <- readLines('TEXTFILE', warn = FALSE)
# combine all text into one character
abstracts <- paste(YOUR CODE HERE) 
# split the text whenever 3 new lines occur in a row (indicating two blank lines)
abstracts <- strsplit(YOURCODEHERE)
```
