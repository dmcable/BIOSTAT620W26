...
subtitle: "BIOSTAT 620 - Week 11"
author: "Abigail Horn, Kelly Street, Dylan Cable"
format:
  revealjs:
    theme: default
    fig-width: 7
...
[this](https://dmcable.github.io/BIOSTAT620W26/).
...
example, the BIOSTAT 620 website contains a footer:

```yaml
  page-footer: 
    left:
      University of Michiagan <br>
      Department of Biostatistics
    right:
      LICENSE <br>
      View the [source at GitHub](https://github.com/dmcable/BIOSTAT620W26).
```
...
Useful tutorials:
 ...
 - Video series (ft. Emil Hvitfeldt): [Quarto Websites with Charlotte and Emil](https://www.youtube.com/playlist?list=PLitrm9Undxcu7eExaTg9Y-JYLv9O6uxGu)
