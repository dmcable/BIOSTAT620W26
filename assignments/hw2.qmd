...
the number of rows. Make sure the number of rows in `individual` matches the number of rows of the merged object.
...
in total. Count the number in each category.
